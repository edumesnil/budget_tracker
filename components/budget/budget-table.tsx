...
export function BudgetTable({ budgets, monthName, year, onEdit, onDelete }: BudgetTableProps) {
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Track your budget vs. actual spending for {monthName} {year}
        </CardDescription>
        ...
        {filteredBudgets.length === 0 ? (
          <div className="text-center py-10">
            <p className="text-muted-foreground">
              No budget items found for {monthName} {year}. Add your first budget item to get started.
            </p>
          </div>
        ) : (
          <CustomTable>
